...
def make_svg(obs: Observation, forecasts: list[ForecastPoint], risk: RiskResult, validation: ValidationResult, out_path: Path) -> Path:
    ...
    # แถบน้ำต้องอยู่ภายในกรอบ (box x=92 y=340 w=430 h=205) เท่านั้น
    # col_top = เส้นขอบตลิ่ง (น้ำเต็ม), col_bottom = ก้นกรอบ (น้ำแห้ง)
    col_top = 385
    col_bottom = 525
    water_h = max(6, int(pct * (col_bottom - col_top)))
    water_y = col_bottom - water_h
  ...
  <text x="78" y="88" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="38" font-weight="800" fill="#0f172a">รอดมั้ย? น้ำเจ้าพระยา อินทร์บุรี</text>
  <text x="82" y="125" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="21" fill="#475569">ภาพเข้าใจง่ายสำหรับชุมชน · อัปเดต {_e(obs.ts.strftime('%d/%m/%Y %H:%M น.'))}</text>

  <rect x="78" y="152" width="315" height="145" rx="28" fill="#eff6ff"/>
  <text x="105" y="195" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="22" font-weight="700" fill="#1e3a8a">ระดับน้ำตอนนี้</text>
  <text x="105" y="255" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="56" font-weight="900" fill="#0f172a">{_e('?' if obs.level_msl is None else f'{obs.level_msl:.2f}')}</text>
  <text x="255" y="255" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="24" fill="#475569">ม.รทก.</text>

  <rect x="430" y="152" width="315" height="145" rx="28" fill="#f0fdf4"/>
  <text x="457" y="195" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="22" font-weight="700" fill="#14532d">ท้ายเขื่อนเจ้าพระยา</text>
  <text x="457" y="255" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="56" font-weight="900" fill="#0f172a">{_e('?' if obs.discharge_cms is None else f'{obs.discharge_cms:.0f}')}</text>
  <text x="610" y="255" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="24" fill="#475569">ลบ.ม./วิ</text>

  <rect x="782" y="152" width="315" height="145" rx="28" fill="{bg}"/>
  <text x="810" y="195" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="22" font-weight="700" fill="{text}">สถานะชุมชน</text>
  <text x="810" y="255" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="40" font-weight="900" fill="{main}">{_e(risk.emoji)} {_e(risk.level)}</text>
  ...
  <text x="132" y="375" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="18" fill="#991b1b">ขอบตลิ่ง {bank:.2f} ม.</text>
  ...
  <text x="132" y="575" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="26" font-weight="800" fill="#0f172a">เหลือจากตลิ่ง: {_e(fmt_m(risk.freeboard_m))}</text>

  <rect x="570" y="335" width="527" height="220" rx="28" fill="#f8fafc" stroke="#e2e8f0"/>
  <text x="602" y="382" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="27" font-weight="900" fill="#0f172a">น้องเจ้าพระยาบอกว่า...</text>
  <text x="602" y="430" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="35" font-weight="900" fill="{main}">{_e(caption_level)}</text>
  <text x="602" y="478" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="25" fill="#334155">คาดการณ์: {_e(forecast_line)}</text>
  <text x="602" y="520" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="22" fill="#475569">ความเชื่อมั่น {validation.confidence}% · โมเดลคลาดเคลื่อน ±{validation.model_rmse_m:.2f} ม.</text>
  ...
  <text x="78" y="620" font-family="Loma, Garuda, Sarabun, Noto Sans Thai, sans-serif" font-size="18" fill="#64748b">ระบบช่วยเฝ้าระวัง ไม่ใช่ประกาศราชการ · ถ้าข้อมูลไม่ครบ ระบบจะลดความเชื่อมั่นและไม่โพสต์เตือนเกินจริง</text>
</svg>'''
